...
public:
    ...
    // define datatype
    using mmInputType = typename JittorInferFlashAttentionTypeTraits<T, M>::mmInputType;
    using mmBiasType = typename JittorInferFlashAttentionTypeTraits<T, M>::mmBiasType;
    using mmOutputType = typename JittorInferFlashAttentionTypeTraits<T, M>::mmOutputType;
    using softmaxType = typename JittorInferFlashAttentionTypeTraits<T, M>::softmaxType;
    using pseShiftType = typename JittorInferFlashAttentionTypeTraits<T, M>::pseShiftType;
    using pseShiftCastType = typename JittorInferFlashAttentionTypeTraits<T, M>::pseShiftCastType;
    // define matmul
...
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::Init(__gm__ uint8_t* query, __gm__ uint8_t* key,
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::InitOutputSingleCore()
{
...
#ifndef PFA_UT
template<>
__aicore__ inline void JittorInferFlashAttentionBase<int8_t, bool, CubeFormat::ND, int8_t>::InitOutputSingleCore() {}

template<>
__aicore__ inline void JittorInferFlashAttentionBase<int8_t, half, CubeFormat::ND, int8_t>::InitOutputSingleCore() {}

template<>
__aicore__ inline void JittorInferFlashAttentionBase<int8_t, float, CubeFormat::ND, int8_t>::InitOutputSingleCore() {}
#endif
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::initOffset() {
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::InitTensorSize(
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::ElewiseCompute(LocalTensor<mmOutputType>& mmResUb,
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::SoftmaxBasicComputeFirst(LocalTensor<mmOutputType>& mmResUb,
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::SoftmaxComputeFirst(LocalTensor<mmOutputType>& mmResUb,
                                        LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb, SoftMaxShapeInfo& shapeInfo) {
    SoftMax<softmaxType, true> (mmResUb, softmaxSumUb, softmaxMaxUb, mmResUb, softmaxTilingData, shapeInfo);
}

template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline bool JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::IsSoftmaxBasic() {
    return ((this->softmaxTilingData.splitM % 8 ==0) && (this->softmaxTilingData.splitK % 64 ==0));
}

template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::SoftmaxBasicCompute(LocalTensor<mmOutputType>& mmResUb,
                                        LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb,
                                        LocalTensor<softmaxType>& softmaxExpUb, SoftMaxShapeInfo& shapeInfo) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::SoftmaxCompute(LocalTensor<mmOutputType>& mmResUb,
                                        LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb,
                                        LocalTensor<softmaxType>& softmaxExpUb, SoftMaxShapeInfo& shapeInfo) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::SoftmaxBasicComputeFirstNoTail(LocalTensor<mmOutputType>& mmResUb,
                                                        LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb,
                                                        LocalTensor<softmaxType>& softmaxExpUb, LocalTensor<uint8_t>& sharedTmpUb,
                                                        SoftMaxShapeInfo& shapeInfo) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::SoftmaxBasicComputeNoTail(LocalTensor<mmOutputType>& mmResUb,
                                                    LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb,
                                                    LocalTensor<softmaxType>& softmaxExpUb, LocalTensor<uint8_t>& sharedTmpUb,
                                                    SoftMaxShapeInfo& shapeInfo) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::SoftmaxComputeFirstTail(LocalTensor<mmOutputType>& mmResUb,
                                            LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb,
                                            LocalTensor<softmaxType>& softmaxExpUb, SoftMaxShapeInfo& shapeInfo) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::SoftmaxComputeTail(LocalTensor<mmOutputType>& mmResUb,
                                            LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb,
                                            LocalTensor<softmaxType>& softmaxExpUb, SoftMaxShapeInfo& shapeInfo) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline bool JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::IsSoftmaxFlashBasic() {
    return ((this->softmaxFlashTilingData.splitM % 8 ==0) && (this->softmaxFlashTilingData.splitK % 64 ==0));
}

// quant: add quant functions
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::QuantCompute(LocalTensor<int8_t> quantResUb, LocalTensor<mmOutputType> mmResUb,
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::Bmm2UpdateDivNoTail(LocalTensor<mmOutputType>& bmm2ResPreUb,
                                            LocalTensor<float>& softmaxSumUb, LocalTensor<softmaxType>& softmaxExpUb) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O, Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::Bmm2Compute(uint32_t offset, LocalTensor<mmOutputType>& bmm2ResL1) {
#if (__CCE_AICORE__ > 200)
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::UpdateVmul(LocalTensor<softmaxType>& softmaxExpUb) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::ComputePseShiftOffset(int sInnerOffsetDataSize) {
    if (!usePseShift) {
        return;
    }
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::ComputeAttenMaskOffset(int sInnerOffsetDataSize) {
    int32_t delta;
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::ComputeAttenMaskOffsetPre(int sInnerOffsetDataSize) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::ComputeOffset(uint32_t sInnerLoopIdx) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::ComputeOffsetWithBNSD(uint32_t sInnerLoopIdx) {
    int sInnerOffsetDataSize = sInnerLoopIdx * singleProcessSInnerSize;
    ComputePseShiftOffset(sInnerOffsetDataSize);
    ComputeAttenMaskOffset(sInnerOffsetDataSize);
    ComputeAttenMaskOffsetPre(sInnerOffsetDataSize);
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::DataCopyTransposeOut(LocalTensor<mmOutputType>& bmm2ResUb) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::DataCopyOutWithBNSD(LocalTensor<mmOutputType>& bmm2ResUb) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::CalPseShiftOffset(int sIdx) {
    if (!usePseShift) {
        return;
    }
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::LoopSOuterOffsetInit(uint32_t seqListOffsetSize, int sIdx) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::LoopSOuterOffsetInitWithBNSD(uint32_t seqListOffsetSize,
                                                                                    int sIdx) {
    uint64_t attenMaskBatchOffset = 0;
    if (attenMaskBatch != 1) {
        attenMaskBatchOffset = (uint64_t)sIdx * (uint64_t)tilingData->promptAttentionBaseParams.maskKVsSize *
...
template<typename T, typename U, CubeFormat FORMAT, typename O,  Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::Bmm2UpdateAdd(LocalTensor<mmOutputType>& bmm2ResUb) {
    LocalTensor<mmOutputType> bmm2ResPreUb = tempBmm2Ub.Get<mmOutputType>(bmm2ResUbSize);
    Add(bmm2ResPreUb, bmm2ResUb, bmm2ResPreUb, bmm2ResUbSize);
}

template<typename T, typename U, CubeFormat FORMAT, typename O, Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::GetSingleCoreParam(int sIdx) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O, Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::GetSparseParam(int32_t* preTokens,
                                                                                 int32_t* nextTokens) {
...
template<typename T, typename U, CubeFormat FORMAT, typename O, Mode M>
__aicore__ inline void JittorInferFlashAttentionBase<T, U, FORMAT, O, M>::ComputeTokenOffset() {
