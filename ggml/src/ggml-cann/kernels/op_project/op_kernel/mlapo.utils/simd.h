...
__aicore__ inline void cgadd_v(AscendC::LocalTensor<DType> dst,
                               ...
                               const int32_t repeat, const int32_t dstRepStride,
                               const int32_t srcBlkStride,
                               const int32_t srcRepStride) {
    AscendC::BlockReduceSum<DType, false>(dst, src, repeat, 0, dstRepStride,
...
__aicore__ inline void add_v(AscendC::LocalTensor<DType> dst,
                             ...
                             AscendC::LocalTensor<DType> src1, uint8_t repeat,
                             uint8_t dstBlockStride, uint8_t src0BlockStride,
    ...
    AscendC::Add<DType, false>(
        ...
        AscendC::BinaryRepeatParams(dstBlockStride, src0BlockStride,
                                    src1BlockStride, dstRepeatStride,
...
__aicore__ inline void adds_v(AscendC::LocalTensor<DType> dst,
                              AscendC::LocalTensor<DType> src,
                              DType scalarValue, uint8_t repeat,
                              uint8_t dstBlockStride, uint8_t srcBlockStride,
                              uint8_t dstRepeatStride,
                              uint8_t srcRepeatStride) {
    AscendC::Adds<DType, false>(
        dst, src, scalarValue, (uint64_t)0, repeat,
        AscendC::UnaryRepeatParams(dstBlockStride, srcBlockStride,
...
__aicore__ inline void cadd_v(AscendC::LocalTensor<DType> dst,
                              AscendC::LocalTensor<DType> src, uint8_t repeat,
                              uint16_t dstRepeatStride, uint16_t srcBlockStride,
                              uint16_t srcRepeatStride) {
    AscendC::RepeatReduceSum<DType, false>(dst, src, repeat, 0, 0,
                                           srcBlockStride, dstRepeatStride,
                                           srcRepeatStride);
}
/////////////////////////////////////////////////////
// vbrcb
...
__aicore__ inline void brcb_v(AscendC::LocalTensor<DType> dst,
                              AscendC::LocalTensor<DType> src,
                              uint16_t dstBlockStride, uint16_t dstRepeatStride,
                              uint8_t repeat) {
    AscendC::Brcb(dst, src, repeat,
                  AscendC::BrcbRepeatParams(dstBlockStride, dstRepeatStride));
}
...
__aicore__ inline void cmax_v(AscendC::LocalTensor<DType> dst,
    ...
    AscendC::WholeReduceMax<DType, false>(dst, src, (int32_t)0, repeat,
                                          dstRepeatStride, srcBlockStride,
...
__aicore__ inline void conv_v(AscendC::LocalTensor<DTypeOut> dst,
                              AscendC::LocalTensor<DTypeIn> src, uint8_t repeat,
                              uint16_t dstBlockStride, uint16_t srcBlockStride,
                              uint16_t dstRepeatStride,
                              uint16_t srcRepeatStride) {
    if constexpr (std::is_same<DTypeIn, float>::value &&
                  std::is_same<DTypeOut, __bf16>::value) {
...
__aicore__ inline void convr_v(AscendC::LocalTensor<DTypeOut> dst,
                               ...
                               uint8_t repeat, uint16_t dstBlockStride,
...
__aicore__ inline void muls_v(AscendC::LocalTensor<DType> dst,
                              AscendC::LocalTensor<DType> src0, DType src1,
                              uint8_t repeat, uint16_t dstBlockStride,
...
/////////////////////////////////////////////////////
template <ArchType ArchTag, typename DType>
__aicore__ inline void tranpose_v(AscendC::LocalTensor<DType> dst,
                                  AscendC::LocalTensor<DType> src) {
...
__aicore__ inline void cgmax_v(AscendC::LocalTensor<DType> dst,
                               ...
                               const int32_t srcBlkStride,
                               const int32_t srcRepStride) {
    AscendC::BlockReduceMax<DType, false>(dst, src, repeat, 0, dstRepStride,
                                          srcBlkStride, srcRepStride);
}
#endif