...
extern "C" __global__ __aicore__ void rope_ext_custom(GM_ADDR x, GM_ADDR pos, GM_ADDR dst, GM_ADDR workspace, GM_ADDR tiling) {
    ...
    op.Init(x, pos, dst, 
        tiling_data.ne0,tiling_data.ne1,
        tiling_data.s1,tiling_data.s2,
        tiling_data.n_dims,
        tiling_data.freq_scale,
        tiling_data.theta_scale,
        tiling_data.ext_factor,
        tiling_data.attn_factor,
        tiling_data.corr_dims_v_0,
        tiling_data.corr_dims_v_1,
        tiling_data.logf_1_freq_scale,
        tiling_data.pos_len);
    op.Process();
}