...
class JittorInferFlashAttentionS1s2Bns1X910 : public JittorInferFlashAttentionS1s2Bns1X910Base<PFAT> {
public:
    using FT = float;
    ...
    using mmOutputTypeTmp = typename JittorInferFlashAttentionTypeTraits<T,PFAT::calcMode>::mmOutputType;
    using computeType = typename JittorInferFlashAttentionTypeTraits<T,PFAT::calcMode>::softmaxType;
    using pseShiftType = typename JittorInferFlashAttentionTypeTraits<T,PFAT::calcMode>::pseShiftType;
    using pseShiftCastType = typename JittorInferFlashAttentionTypeTraits<T,PFAT::calcMode>::pseShiftCastType;
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::AllocGlobalResources() {
    for (int i = 0; i < 2; ++i) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::FreeGlobalResources() {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::PseOrMaskCopyIn(int64_t offset, uint32_t souterSize,
    bool isInnerTail, uint32_t alignSInner, uint32_t unalignSInner, uint32_t padSize, bool isMask, uint32_t souterTailMaskCopyInSize) {
    // Optimize for small Q_S using the actual required Q_S.
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::Bmm1VecInputCopyIn() {
    PFAComputeParam *params = this->headParams;
    if (params->fakeMsg) {
        return;
    }
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::SparseBandElewiseCompute(int32_t ubPingpong, uint32_t souterSize, int64_t attenMaskOffsetPre) {
    PFAComputeParam *params = this->headParams;
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::MsdRowSum(LocalTensor<FT>& dstUb, LocalTensor<FT> srcUb,
                                                                         uint32_t dealRowCount, uint32_t columnCount, uint32_t actualColumnCount) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::MsdRowMax(LocalTensor<FT>& aMaxDstUb, LocalTensor<FT>& srcUb,
                                                                         uint32_t dealRowCount, uint32_t columnCount, uint32_t actualColumnCount) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::MsdAbsRowMax(LocalTensor<FT>& tmpAMaxRes, LocalTensor<FT>& srcUb, LocalTensor<FT> tmpAUb, 
                                                                            uint32_t dealRowCount, uint32_t columnCount, uint32_t actualColumnCount) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::MsdRowMuls(LocalTensor<FT>& dstUb, LocalTensor<FT>& src0Ub, LocalTensor<FT>& src1Ub, 
                                                                          uint32_t dealRowCount, uint32_t columnCount, uint32_t actualColumnCount) {
    uint32_t dtype_mask = this->MSD_REPEAT_ELEMENT_NUM;
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::MsdAntiParamsMulByRow(LocalTensor<FT>& dstUb, LocalTensor<FT>& antiParams, LocalTensor<FT>& src1Ub, 
                                                                                     uint32_t dealRowCount, uint32_t columnCount, uint32_t actualColumnCount) {
    uint32_t dtype_mask = this->MSD_REPEAT_ELEMENT_NUM;  
    uint32_t dLoop = actualColumnCount / dtype_mask;    
    uint32_t dRemain = actualColumnCount % dtype_mask;   
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::MsdFusedMulAddByRow(LocalTensor<FT>& dstLocal, LocalTensor<FT>& src0Local, LocalTensor<FT>& src1Local, 
                                                                                   uint32_t dealRowCount, uint32_t columnCount, uint32_t actualColumnCount) {
    uint32_t dtype_mask = this->MSD_REPEAT_ELEMENT_NUM;  
    uint32_t dLoop = actualColumnCount / dtype_mask;     
    uint32_t dRemain = actualColumnCount % dtype_mask;   
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::MsdMulMaxAddSumByRow(LocalTensor<FT>& dstLocal, LocalTensor<FT>& src0RowMax, LocalTensor<FT>& src1RowSum, 
                                                                                    uint32_t dealRowCount, uint32_t columnCount, uint32_t actualColumnCount) {
    uint32_t dtype_mask = this->MSD_REPEAT_ELEMENT_NUM;  
    uint32_t dLoop = actualColumnCount / dtype_mask;     
    uint32_t dRemain = actualColumnCount % dtype_mask;   
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::MsdVecMulMat(LocalTensor<FT>& dstUb, LocalTensor<FT>& src0Ub, LocalTensor<FT>& src1Ub,
                                                                            uint32_t dealRowCount, uint32_t columnCount, uint32_t actualColumnCount) {
    uint32_t dtype_mask = this->MSD_REPEAT_ELEMENT_NUM;  
    uint32_t dLoop = actualColumnCount / dtype_mask;     
    uint32_t dRemain = actualColumnCount % dtype_mask;   
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::Bmm1MsdCopyQueryGm2Ub(LocalTensor<FT> &queryUb, int64_t queryOffset,
                                                                                     uint32_t dealRowCount, uint32_t columnCount, uint32_t actualColumnCount) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::MsdAIterExpand(GlobalTensor<int8_t> dstGm, LocalTensor<FT>& tmpA1, LocalTensor<FT>& tmpA2, 
                                                                              uint32_t calcSize, bool isFirst, int64_t outOffset, int gmPingpong) {
    if (!isFirst) {
        // sub
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::MsdMatmulPreProcess(PFAComputeParam *params, GlobalTensor<KV_T> dstGm, LocalTensor<FT>& msdMaxResUb, LocalTensor<FT>& srcUb, LocalTensor<FT>& tmpAFloorUb,
                                                                                   uint32_t startRow, uint32_t dealRowCount, uint32_t columnCount, uint32_t actualColumnCount, int gmPingpong) {
...
// Calc ∑𝐴[𝑗]
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::Bmm1MsdCalcQueryRowSum(LocalTensor<FT> &queryUb, 
                                                                                      uint32_t startRow, uint32_t dealRowCount, uint32_t columnCount, uint32_t actualColumnCount, int gmPingpong) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::Bmm1MsdExpandPertoken(PFAComputeParam *params) {
    uint32_t startRow = 0;
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::Bmm1MsdExpand(PFAComputeParam *params) {
    Bmm1MsdExpandPerchannel(params);
}

// 𝑆′=(𝑆1+𝑆2×1/254 +S3×1/254^2)×1/127
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::MsdMatmulResCombine(LocalTensor<FT> &bmmResUb, GlobalTensor<mmOutputType> srcGm, 
                                            uint32_t expandLineCnt, uint32_t startRow, uint32_t dealRowCount, uint32_t columnCount, uint32_t actualColumnCount, int gmPingpong) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::Bmm1MsdSqueeze(PFAComputeParam *params, LocalTensor<FT>& bmm1ResUb, uint32_t startRow, uint32_t dealRowCount, int ubPingpong, int gmPingpong) {
    Bmm1MsdSqueezePerchannel(params, bmm1ResUb, startRow, dealRowCount, gmPingpong);
    SetFlag<HardEvent::MTE2_V>(this->bmm1ResCopyInEvent[ubPingpong]);
}

template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::Bmm2MsdExpand(PFAComputeParam *params, LocalTensor<FT> &mmResUb, GlobalTensor<KV_T> bmm1ExpandGm, 
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::Bmm2MsdSqueeze(PFAComputeParam *params, LocalTensor<computeType>& bmm2ResUb, GlobalTensor<mmOutputType> bmm2ResGmDb, int gmPingpong) {
...
template <typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::MsdSoftmaxResPreProcess(
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::Bmm1MsdExpandPerchannel(PFAComputeParam *params) {
    // copy scale
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::Bmm1MsdSqueezePerchannel(
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::Bmm2MsdExpandPerchannel(
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::Bmm2MsdSqueezePerchannel(
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::Bmm2UpdateDivPerchannel(LocalTensor<FT> &bmm2ResLastUb) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::Bmm1ResDoVecBmm2Compute() {
    PFAComputeParam *params = this->headParams;
    LocalTensor<computeType> bmm2ResUb;
...
template <typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::CheckRowInvalid(int64_t preTokens, int64_t nextTokens,
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::SInnerLoopFunc(int64_t sInnerFirstToken, int64_t sInnerLastToken, int curBatch,
...
template<typename PFAT>
__aicore__ inline int64_t JittorInferFlashAttentionS1s2Bns1X910<PFAT>::ClipSInnerToken(int64_t sInnerToken, int64_t minValue, int64_t maxValue) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::ComputeEachCoreSInnerLoop() {
    PFAComputeParam *params = this->headParams;
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::ComputeEachCore(uint32_t coreIdx) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::ComputeEachCoreBalance(uint32_t coreIdx) {
    int sNum = this->tilingData->promptAttentionBaseParams.dimNumOfseq;
    if (sNum == 0) {
	    return;
    }
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::InitEachCoreWorkspace(uint32_t coreIdx, int32_t blockNum) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::ComputeEachCoreSplitSeqOneN(uint32_t coreIdx) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910<PFAT>::ProcessLastSouterLoopFinalRes() {
