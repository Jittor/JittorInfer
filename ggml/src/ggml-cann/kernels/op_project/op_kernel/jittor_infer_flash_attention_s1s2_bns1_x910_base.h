...
public:
    ...
    using mmBiasType = typename JittorInferFlashAttentionTypeTraits<T,PFAT::calcMode>::mmBiasType;
                                      ...
                                      const uint64_t tilingPtr, const uint64_t dataPtr)
    {
        ...
        __gm__ JittorInferFlashAttentionTilingData* tilingDataPtr = reinterpret_cast<__gm__ JittorInferFlashAttentionTilingData*>(tilingPtr);
...
protected:
    ...
    __aicore__ inline int64_t CalMultiSeqOffset(int sIdx) {
        ...
        if constexpr (PFAT::layout == PFALayout::BNSD) {
            multiSeqOffset = (int64_t)sIdx * this->tilingData->promptAttentionBaseParams.seqSize * (int64_t)this->MultiHeadQ; // BNSD
        } else {
            multiSeqOffset = (int64_t)sIdx * this->tilingData->promptAttentionBaseParams.seqSize * (int64_t)this->MultiHeadQ; // BSH
        }
   ...
   __aicore__ inline TYPENAME_BSH_VOID LoopSOuterOffsetInit(int64_t seqListOffsetSize, int sIdx) {
        ...
        attenMaskCoreOffset = attenMaskBatchOffset + (uint64_t)(this->tailParams->sOuterOffset) * \
    ...
    __aicore__ inline TYPENAME_BNSD_VOID LoopSOuterOffsetInit(int64_t seqListOffsetSize, int sIdx) {
        ...
        head_stride_kv = tilingData->promptAttentionBaseParams.headSize * tilingData->promptAttentionBaseParams.seqInnerSize;
        ...
        seqInnerOffsetSize =
            tilingData->promptAttentionBaseParams.seqSize == tilingData->promptAttentionBaseParams.seqInnerSize ?
            (seqListOffsetSize) / (int64_t)headNumRatio : (int64_t)sIdx * (int64_t)head_stride_kv *
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::PostQuant2PerChannelBF16(LocalTensor<computeType> &bmm2ResUb, LocalTensor<int8_t> &outputQuantRes) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::PostQuant2PerChannelFP16(LocalTensor<computeType> &bmm2ResUb, LocalTensor<int8_t> &outputQuantRes) {
    if constexpr (IsSameType<computeType, float>::value) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::PostQuant2PerChannelFP32(LocalTensor<computeType> &bmm2ResUb, LocalTensor<int8_t> &outputQuantRes) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::CalPseShiftOffset(int sIdx) {
    if (!(this->tailParams->usePseShift)) {
        return;
    }
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::QuantCompute(LocalTensor<int8_t> quantResUb, LocalTensor<computeType> mmResUb,
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::Init(__gm__ uint8_t* query, __gm__ uint8_t* key,
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::InitLseOutputSingleCore() {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::InitOutputSingleCore()
{
    auto &initParams = tilingData->promptAttentionInitOutputParams;
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::initOffset() {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::InitTensorSize(
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::SoftmaxBasicComputeFirstNoTail(
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::SoftmaxBasicComputeNoTail(LocalTensor<computeType>& mmResUb,
                                            LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb,
                                            LocalTensor<computeType>& softmaxExpUb, uint32_t souterSize) {
    SoftMaxShapeInfo softmaxShapeInfo;
    if (this->headParams->isInnerTail) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::SoftmaxComputeFirstTail(LocalTensor<computeType>& mmResUb,
                                            LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb, uint32_t souterSize) {
    LocalTensor<computeType> null;
    SoftMaxShapeInfo softmaxShapeInfo;
    if (this->headParams->isInnerTail) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::SoftmaxComputeTail(LocalTensor<computeType>& mmResUb,
                                            LocalTensor<float>& softmaxMaxUb, LocalTensor<float>& softmaxSumUb,
                                            LocalTensor<computeType>& softmaxExpUb, uint32_t souterSize) {
    SoftMaxShapeInfo softmaxShapeInfo;
    if (this->headParams->isInnerTail) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::Bmm2UpdateDivNoTail(LocalTensor<computeType>& bmm2ResPreUb,
                                            LocalTensor<float>& softmaxSumUb) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::UpdateVmul(LocalTensor<computeType>& softmaxExpUb) {
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::Bmm2UpdateAdd(LocalTensor<computeType>& bmm2ResUb) {
    LocalTensor<computeType> bmm2ResPreUb = tempBmm2Ub.Get<computeType>(bmm2ResUbSize);
    Add(bmm2ResPreUb, bmm2ResUb, bmm2ResPreUb, bmm2ResUbSize);
}

template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::GetSingleCoreParam(int sIdx) {
    int64_t actualSeqLengthPerBatch = 0;
    int64_t actualSeqLengthKVPerBatch = 0;
...
template<typename PFAT>
__aicore__ inline void JittorInferFlashAttentionS1s2Bns1X910Base<PFAT>::GetSparseParam(int64_t* preTokens, int64_t* nextTokens, int sIdx, PFAComputeParam *&params) {
    ...
    if (attentionMaskType == 4) {
        ...
        if (isActualLenDimsKVNull){
            actualSeqLengthKVPerBatchUser = tilingData->promptAttentionBaseParams.seqInnerSize;
        } else {
