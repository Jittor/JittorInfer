...
PFA_EXTERN_C ge::graphStatus PFATilingFunc(gert::TilingContext* context) {
    ...
    if (context->GetRawTilingData() == nullptr) {
        OPS_LOG_E("JittorInferFlashAttention", "tiling context GetRawTilingData is nullptr!");
        return ge::GRAPH_FAILED;
    }
...
public:
    explicit JittorInferFlashAttention(const char* name) : OpDef(name)
    {
        ...
        this->SetInferShape(ge::PFAInferShape).SetInferDataType(ge::PFAInferDataType);
