...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(NdMLADecodingMtpTilingTP1Op, NdMLADecodingMtpTilingTP1)
...
BEGIN_TILING_DATA_DEF(MLATilingData)
  ...
  TILING_DATA_FIELD_DEF_STRUCT(NdMLADecodingMtpTilingTP1, ndMLADecodingMtpTilingTP1);
...
ge::graphStatus GetMLATilingParam(ContextParamsForMLA& contextParamsForMLA, uint32_t& blockDimToBeSet, MLATilingData& tilingData);
