...
namespace optiling {
static ge::graphStatus RopeTilingFunc(gert::TilingContext* context) {
...
// outputshape = xshape
namespace ge {
static ge::graphStatus RopeInferShape(gert::InferShapeContext* context) {
...
// outputshape = xshape
static ge::graphStatus RopeInferDataType(gert::InferDataTypeContext* context) {
...
class RopeExtCustom : public OpDef {
   public:
    explicit RopeExtCustom(const char* name) : OpDef(name) {
        ...
        this->SetInferShape(ge::RopeInferShape)
            .SetInferDataType(ge::RopeInferDataType);

        this->AICore().SetTiling(optiling::RopeTilingFunc);
