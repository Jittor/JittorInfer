...
static const char * GGML_OP_NAME[GGML_OP_COUNT] = {
    ...
    "GGML_OP_MLA_PREPROCESS", "GGML_OP_GET_SLICE", "GGML_OP_SCATTER_UPDATE", "GGML_OP_RMS_NORM_FUSED"
};
...
struct ggml_tensor * ggml_mla_preprocess(struct ggml_context* ctx, struct ggml_tensor* hiddenState, struct ggml_tensor* gamma1, 
    ...
    struct ggml_tensor* descale1, struct ggml_tensor* descale2, struct ggml_tensor* ctkvScale, struct ggml_tensor* qnopeScale, 
    int32_t N, int32_t headNum, int32_t cacheMode, int32_t quantMode, struct ggml_tensor* q1, struct ggml_tensor* q2)
{
